import{n as e,nt as t,t as n}from"./amplify-init-Cg4Klxtw.js";/* empty css                  *//* empty css                         *//* empty css               */t((()=>{e(),document.addEventListener(`DOMContentLoaded`,()=>{let e=new Date().toISOString().slice(0,10),t=[],r=[],i=[{day:`Monday`,times:[`6:00 AM`,`7:00 AM`],type:`Daily Mass`},{day:`Tuesday`,times:[`6:00 AM`,`7:00 AM`],type:`Daily Mass`},{day:`Wednesday`,times:[`6:00 AM`,`7:00 AM`],type:`Daily Mass`},{day:`Thursday`,times:[`6:00 AM`,`7:00 AM`],type:`Daily Mass`},{day:`Friday`,times:[`6:00 AM`,`7:00 AM`],type:`Daily Mass`},{day:`Saturday`,times:[`7:00 AM`,`5:30 PM`],type:`Anticipated Mass`},{day:`Sunday`,times:[`6:00 AM`,`8:00 AM`,`10:00 AM`,`5:00 PM`],type:`Sunday Mass`}],a=document.getElementById(`date-picker`),o=document.getElementById(`schedule-date-label`),s=document.getElementById(`date-schedule-list`),c=document.getElementById(`date-schedule-empty`),l=document.getElementById(`special-masses-list`),u=document.getElementById(`weekly-tbody`);a.value=e;function d(e){let t=document.createElement(`div`);return t.textContent=e||``,t.innerHTML}function f(e){let[t,n]=e.split(` `),[r,i]=t.split(`:`).map(Number);return n===`PM`&&r!==12&&(r+=12),n===`AM`&&r===12&&(r=0),r*60+i}function p(e){return new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})}function m(e){return new Date(e+`T00:00:00`).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`})}n.models.Mass.observeQuery().subscribe({next:({items:e})=>{t=e,h(),g()},error:e=>{console.error(`Failed to load masses:`,e),s.innerHTML=`<li class="text-sm text-red-500 py-4">Couldn't load masses.</li>`}});function h(){let e=a.value,n=t.filter(t=>t.date===e);if(o.textContent=p(e),s.innerHTML=``,n.length===0){r=[],c.classList.remove(`hidden`);return}c.classList.add(`hidden`),r=n.slice().sort((e,t)=>f(e.time)-f(t.time)),r.forEach((e,t)=>{let n=document.createElement(`li`);n.innerHTML=`
