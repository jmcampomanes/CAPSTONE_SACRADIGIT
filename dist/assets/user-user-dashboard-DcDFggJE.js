        ...
        <div><p class="quick-action-label">${e.label}</p><p class="quick-action-sub">${e.sub}</p></div>
          ...
          <div class="user-ann-card">
            ...
            <div class="user-ann-meta">
              ...
              </tr>`}).join(``)},error:e=>{console.error(e),d.innerHTML=`<tr><td colspan="3" class="text-center text-red-500 text-sm py-8">Couldn't load requests.</td></tr>`}})})}))();