/* ============================================
   SacraDigit — User Request Certificate Scripts
   (user-request-certificate.js)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ------------------------------------------
     0. CERTIFICATE TYPES
     Each type has a set of dynamic fields
     rendered inside the form when selected.
  ------------------------------------------ */
  const certTypes = [
    {
      id: 'baptismal',
      name: 'Baptismal Certificate',
      desc: 'Proof of baptism recorded at the parish.',
    ...
    },
    {
      ...
      desc: 'Proof of confirmation sacrament.',
    ...
    },
    {
      ...
      desc: 'Parish record of a Catholic marriage.',
    ...
    },
    {
      ...
      desc: 'Parish record of a Catholic burial or funeral mass.',
  ...
  /* ------------------------------------------
     1. RENDER — certificate type selector cards
  ------------------------------------------ */
  ...
  /* ------------------------------------------
     2. SELECT TYPE — render form fields
  ------------------------------------------ */
  function selectType(id) {
    ...
    dynamicFields.innerHTML = selectedType.fields.map(f => `
      <div class="${f.id === 'baptized-name' || f.id === 'confirmed-name' || f.id === 'groom-name' ? 'sm:col-span-2' : ''}">
